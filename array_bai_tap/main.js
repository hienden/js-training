...
// Bài tập 7: Ghép mảng
// Viết một hàm có tên "concatArrays" nhận vào hai mảng và trả về một mảng mới
// chứa tất cả các phần tử từ hai mảng đầu vào.
...
// Viết một hàm có tên "removeDuplicates" nhận vào một mảng và trả về một mảng mới
//chỉ chứa các phần tử duy nhất (loại bỏ các giá trị trùng nhau).

function removeDuplicates(arr) {
  const uniqueChars = arr.filter((element, index) => {
    return arr.indexOf(element) === index; // 0===0
    //
  });
  return uniqueChars;
}
